    ...
    <section className="section bg-navy" style={{ 
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-3 gap-8" style={{ marginBottom: '4rem', maxWidth: '900px', margin: '0 auto 4rem auto' }}>
          <div className="card" style={{ background: 'rgba(255, 255, 255, 0.05)', borderColor: 'var(--gold)', backdropFilter: 'blur(10px)' }}>
            <h2 className="text-gold" style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>€200M</h2>
            <p style={{ color: 'var(--off-white)' }}>Target Fund Size</p>
          </div>
          <div className="card" style={{ background: 'rgba(255, 255, 255, 0.05)', borderColor: 'var(--gold)', backdropFilter: 'blur(10px)' }}>
            <h2 className="text-gold" style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>20%</h2>
            <p style={{ color: 'var(--off-white)' }}>Target Project IRR</p>
          </div>
          <div className="card" style={{ background: 'rgba(255, 255, 255, 0.05)', borderColor: 'var(--gold)', backdropFilter: 'blur(10px)' }}>
            <h2 className="text-gold" style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>2.5×</h2>
            <p style={{ color: 'var(--off-white)' }}>Target MOIC (Multiple on Invested Capital)</p>
          </div>
        </div>
